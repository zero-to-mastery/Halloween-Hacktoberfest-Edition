var movieList = [
  ...
  },
  {
    ...
    imageURL:
      'https://images.mentalfloss.com/sites/default/files/styles/mf_image_16x9/public/corpsehed.jpg?itok=0cnYDZLJ&resize=1100x1100',
    movieUrl: 'https://www.imdb.com/title/tt0121164/'
  },
  {
    movieName: 'Moster House',
    imageURL:
      'http://www.asset1.net/tv/pictures/movie/monster-house-2006/Monster-House-01-1.jpg',
  ...
  },
  {
    movieName: 'Coraline',
    imageURL:
      'http://cdn-static.denofgeek.com/sites/denofgeek/files/8/01//coraline-main.jpg',
    movieUrl: 'https://www.imdb.com/title/tt0327597/'
  },
  {
    movieName: 'Haunted Mansion',
    imageURL:
      'https://resizing.flixster.com/Jq0fHDenDeKgJ7FRJB01E3WYtfQ=/3000x1937/v1.bjszOTEwMzY7ajsxNzgyNDsxMjAwOzMwMDA7MTkzNw',
    movieUrl: 'https://www.imdb.com/title/tt3875444/'
  },
  {
    movieName: 'Hocus Pocus',
    imageURL:
      'https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/hocus-pocus-1538085764.jpg',
  ...
  },
  {
    ...
    imageURL:
      'http://digitalspyuk.cdnds.net/17/32/1600x800/landscape-1502465209-i-know-what-you-did-last-summer.jpg',
    movieUrl: 'https://www.imdb.com/title/tt0119345/'
  },
  {
    movieName: 'Interview with the Vampire',
    imageURL:
      'http://media3.s-nbcnews.com/i/streams/2014/March/140310/2D274905334475-ss-100112-Tom-Cruise-1994-interview.jpg',
    movieUrl: 'https://www.imdb.com/title/tt0110148/'
  },
  {
    movieName: 'Scream',
    imageURL:
      'https://images.mentalfloss.com/sites/default/files/styles/mf_image_16x9/public/scream-header.png?itok=TGb3gk_m&resize=1100x1100',
    movieUrl: 'https://www.imdb.com/title/tt0117571/'
  },
  {
    movieName: 'The Shining',
    imageURL:
      'https://static.gamespot.com/uploads/original/1578/15789737/3345293-theshining.jpg',
    movieUrl: 'https://www.imdb.com/title/tt0081505/'
  },
  {
    movieName: 'Trick or Treat',
    imageURL:
      'https://www.legendary.com/wp-content/uploads/2015/10/News_TRTDOTD_desktop_1600x900.jpg',
  ...
  },
  {
    ...
    imageURL:
      'https://www.syfy.com/sites/syfy/files/2017/12/addamsfamilyvalues-header.jpg',
    movieUrl: 'https://www.imdb.com/title/tt0101272/'
  },
  {
    movieName: 'Beetlejuice',
    imageURL:
      'http://images.amcnetworks.com/ifccenter.com/wp-content/uploads/2012/07/beetlejuice_1280x720.jpg',
  ...
  // adding more scary movies
  {
    ...
    imageURL:
      'https://images-na.ssl-images-amazon.com/images/I/A17D9d%2BtSML._SY445_.jpg',
    movieUrl: 'https://www.imdb.com/title/tt0070047/'
  },
  {
    movieName: 'Poltergeist',
    imageURL:
      'https://images-na.ssl-images-amazon.com/images/I/81yuQrgfhYL._SY445_.jpg',
    movieUrl: 'https://www.imdb.com/title/tt0084516/'
  },
  {
    movieName: 'Alien',
    imageURL:
      'https://m.media-amazon.com/images/M/MV5BNDUzMTUwNjA4NV5BMl5BanBnXkFtZTYwMzEwOTk2._V1_.jpg',
    movieUrl: 'https://www.imdb.com/title/tt0078748/'
  },
  {
    movieName: 'The Texas Chainsaw Massacre',
    imageURL:
      'https://cdn.mos.cms.futurecdn.net/RdwU2pc7fBtabesE2sPGhQ-970-80.jpg',
  ...
  },
  {
    ...
    imageURL:
      'https://m.media-amazon.com/images/M/MV5BNThkYmNmYzAtOGI2Ny00ODI4LTgwY2MtZmY3YWMxYTUyYjVjXkEyXkFqcGdeQXVyNTIzOTk5ODM@._V1_SY1000_CR0,0,674,1000_AL_.jpg',
...
const change = () => {
  let addCardChange = '';
  addCardChange +=
    '<div class="card-deck"><div class="card" style="width: 90%;">';
  addCardChange +=
    '<img class="card-img-top" src="' +
    movieList[counter].imageURL +
    '" alt="name">';
  addCardChange +=
    '<div class="card-img-overlay"><h4 class="card-title cardMovieTitle"><a href="' +
    movieList[counter].movieUrl +
    '" target="_blank">' +
    movieList[counter].movieName +
    '</a></h4></div></div></div>';
...
const stopShuffle = () => {
  ...
  const randNoMov =
    Math.floor(Math.random() * (+randMaxMov - +randMinMov)) + +randMinMov;
